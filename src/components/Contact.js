...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_55xc1vd', 'template_bb5b5bn', form.current, 'user_xvQe1qYZLCzayiUehNCfs')
            .then((result) => {
        ...
        <section className='my-28' id='contact'>
            ...
            <div className='md:mx-6 flex flex-col flex-wrap md:flex-row justify-between'>
                <div className='md:w-6/12 md:px-0 p-5 my-5'>
                    <div>
                        <p className='font-bold'>Prangan Sen</p>
                        <p className='font-thin'>Chattogram, Bangladesh</p>
                        <a href='mailto:prangan.sen1@gmail.com' className='border-b-2 mt-3 inline-block border-gray-500'>
                            prangan.sen1@gmail.com
                        </a>
                    </div>
                    <a className='border-b-2 mt-3 inline-block border-gray-500' href='./Prangan Sen Resume.pdf' target='_blank' rel='noreferrer'>
                        Resume
                    </a>
                    <div className='flex flex-row flex-wrap mt-7'>
                        <div className='mr-4'>
                            <a href='https://www.linkedin.com/in/prangansen/' target='_blank' rel='noreferrer'>
                        ...
                        <div className='mr-4'>
                            <a href='https://github.com/prangancode' target='_blank' rel='noreferrer'>
                                <span className='mb-2 flex flex-row items-end border border-gray-500 p-2 rounded-lg text-sm'>
...
// service_55xc1vd
// template_bb5b5bn
//  User Id : user_xvQe1qYZLCzayiUehNCfs